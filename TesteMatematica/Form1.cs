    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckTheAnswer())
            {
                ...
                timer1.Stop();
                MessageBox.Show("Você respondeu tudo certo.",
                                "Parabéns!");
            ...
            else if (timeLeft > 0)
            {
                ...
                // Time Left label.
                timeLeft = timeLeft - 1;
                timeLabel.Text = timeLeft.ToString() + " segundos";
            }
            else
            {
        ...
        private void answer_Enter(object sender, MouseEventArgs e)
        {
            // Select the whole answer in the NumericUpDown control.
            NumericUpDown answerBox = sender as NumericUpDown;
        ...
        private void PlaySucesso()
        {
            new SoundPlayer("./sucesso.wav").Play();
        }

        private void PlayErro()
        {
            new SoundPlayer("./falha.wav").Play();
        }
